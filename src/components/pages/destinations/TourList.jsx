        ...
        <div className="row">
          <div className="col-xl-3 col-lg-4">
            <div className="lg:d-none">
              <Sidebar2 price={price}  sendData={receiveDataFromChild} filteredProductData={filteredProductData} productData={productData} sendFilter={receiveDataFromChildFilter}/>
            </div>
            <div className="accordion d-none mb-30 lg:d-flex js-accordion">
              <div className={`accordion__item col-12 ${sidebarActive ? "is-active" : ""} `}>
                ...
                <div className="accordion__content" style={sidebarActive ? { maxHeight: "2000px" } : {}}>
                  <div className="pt-20">
                    <Sidebar2  sendData={receiveDataFromChild} filteredProductData={filteredProductData} productData={productData}  sendFilter={receiveDataFromChildFilter}/>
                  </div>
                </div>
              </div>
            </div>
